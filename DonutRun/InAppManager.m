...
static NSString* productID1 = @"ED1";
static NSString* productID2 = @"STYLEMAPS";
static NSString* productID3 = @"ANOTHER_PROD";
    ...
    if ([SKPaymentQueue canMakePayments]) {
        ...
        for (int i=0; i < [purchaseableProducts count]; i++) {
            ...
            if ([[selectedProduct productIdentifier] isEqualToString:featureID ]) {
                ...
                // if we found a SKProduct in the purchaseable Products array with the same ID as the one we want to buy, we proceed by putting it in the payment queue.
